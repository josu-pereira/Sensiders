 ...
 * @author haley
 */
public class TelaDashboard2 extends javax.swing.JFrame {
    //Integer nmr = 0;
    /**
    ...
    public TelaDashboard2(Usuario userLogado){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDashboard2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
