...
read -p " Gostaria de instalar uma window manager i3 ou uma gui lxde ou nao?(i3/lxde/n)" gui
if [[ $gui == "i3" ]]
	then
		echo -e "\e[48;5;204m [Sensiders]: \e[0m Estaremos instalando os pacotes, aguarde..."
		...
		sudo sed -i 's/allowed_users=console/allowed_users=ubuntu/g' /etc/X11/Xwrapper.config
		service xrdp start
